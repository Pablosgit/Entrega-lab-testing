...
describe("Mapper tests", () => {
  it("should return objet with empty data when feeding undefined project",() =>{
    // Arrange
  ...
  it("should return objet with empty data when feeding null project",() =>{
    // Arrange
    const project = null;
    // Act
    const result = mapProjectFromApiToVm(project);
  ...
  it("should return objet with empty data when feeding objet empty data project",() =>{
    // Arrange
